...
const ProductsPage = () => {
  ...
  return (
    <div className="products-page py-12 px-6 bg-gray-100">
        ...
        {products.map((product) => (
          ...
          >
           <div className="flex items-center px-4">
            <img src={product.imgUrl} className="w-32 h-32 rounded-md" alt="" />
           <div className="p-6 flex-grow">
              ...
              <p className="text-gray-600 text-sm mb-4">Price: Rp.{product.price.toLocaleString()}</p>
